...
//            this.gmcLogo;
            ...
            this.envGUIArray = ['reflection' + this._reflection, 'paris'];
...
//                {code:'G1G',name:'Longbeach Red Metallic Tintcoat', color:0x871225,roughness: .6,metalness: .2,clearCoat: 1,clearCoatRoughness: 0,reflectivity: 0,envMapIntensity: .6},
            ...
            this.caliperPos = 1;
            this.caliperTotal = ["yellow","red","black","grey"];
...
//                console.log(renderer.toneMappingExposure);
                ...
                _this.renderer.shadowMap.bias = 10;
                _this.renderer.shadowMap.type = 2;
...
//                _this.controls.maxPolarAngle = THREE.Math.degToRad(90); // radians
...
//               
                ...
                _this.pivotWheelFR.position.y = 53.5;
...
//                _this.ambient = new THREE.AmbientLight( 0 ); //0x444444
//                _this.ambient.intensity = 1;
//                scene.add( ambient );
                
//                _this.hemiLight = new THREE.HemisphereLight( 0xffffff, 0, 1.02 );
//				scene.add( hemiLight );
...
//                dirLight = new THREE.DirectionalLight( 0xffffff, 1 ); // Hills 0xffffff // Field 0xffffda 
                _this.dirLight = new THREE.DirectionalLight( 0xffffff, 1 );
...
//                dirLight.position.set( -129, 920, 3 );
                _this.dirLight.position.set( 47, 1000, 444 ); //135, 567, -41
...
//                scene.add( dirLight );
                ...
                _this.scene.add( _this.dirLight ); // dynamic shadow map effect (cool!)
...
//                                      map: createColorTexture('#37547A')
            //                          depthWrite: false,
            //                        wireframe: true,
                                    map: _this.loaderTextures.load( 'textures/' + _this.envGUICurrent + '/pano.jpg', function ( texture ) { 
//                                    map: _this.loaderc.load( 'textures/' + _this.envGUICurrent + '/pano_' + _this.textureformat + '.ktx', function ( texture ) { //'textures/' + envGUICurrent + '/pano.jpg'
...
//                                        _this.renderer.setTexture2D(texture, 0);
//                                        _this.composer.render();
//            ////                            matBlob.depthWrite = false;
...
//                                        console.log(model.children[3].material);
                                    ...
                                    else if (model.name == 'steering' )
                                    {
                                        ...
                                        model.children[0].material = _this.matPaint;
...
//                                        model.children[1].material = _this.matLicense;
                                    ...
                                    else if (model.name == 'side' )
                                    {
                                        ...
                                        model.children[29].material = _this.matPrimer;
                                    }
                                    ...
                                    else if (model.name == 'door' )
                                    {
                                        ...
                                        model.children[1].material = _this.matAlloy;
                                        model.children[3].material = _this.matPlastic;
                                        model.children[4].material = _this.matPrimer;
                                        model.children[5].material = _this.matPlasticGloss;
                                        model.children[6].material = _this.matPrimer;
                                        model.children[7].material = _this.matAluDark;
                                        model.children[8].material = _this.matAluDark;
                                        model.children[9].material = _this.matPlasticDark;
                                        model.children[12].material = _this.matAlu;
                                        model.children[12].material = _this.matMirrorGlas;
                                        model.children[13].material = _this.matGlas;
                                        
//                                        model.children[2].material = _this.matChrome; 
//                                        model.children[3].material = _this.matChrome;
//                                        model.children[4].material = _this.matChrome;
//                                        model.children[5].material = _this.matPaint;
//                                        model.children[6].material = _this.matMirrorGlas;
                                    }
...
//                                        else if (model.name == 'wheel2')
//                                        {
//                                            model.children[0].material = _this.matTire;
//                                            model.children[1].material = _this.matTread;
//                                            model.children[2].material = _this.matPlastic;
//                                            model.children[3].material = _this.matAlu;
//                                            model.children[4].material = _this.matAlu;
//                                            model.children[5].material = _this.matAlu;
//                                            model.children[6].material = _this.matAlu2;
//                                            model.children[7].material = _this.matPlastic; 
//                                            model.children[8].material = _this.matChrome;
//                                        }
//                                        else if (model.name == 'wheel3')
//                                        {
//                                            model.children[0].material = _this.matTire;
//                                            model.children[1].material = _this.matTread;
//                                            model.children[2].material = _this.matPlastic;
...
//                                            model.children[4].material = _this.matAlu;
//                                            model.children[5].material = _this.matAlu;
//                                            model.children[6].material = _this.matPlastic;
//                                            model.children[7].material = _this.matChrome;
//
//                                        }
                                            
//                                    }
//                                    if (model.children[k].material == _this.matPlastic)
//                                        model.children[k].receiveShadow = false;
//                                    if (model.children[k].material == matInteriorBlack)
//                                        model.children[k].receiveShadow = true;
                                    
//                                    if (model.children[k].material)
//                                        model.children[k].material.needsUpdate = true;
//                                    }
...
//                    
                  ...
                  changeWheel(2);
                  changeCaliperColor(_this.caliperPos);
                  resizeTimer();
                        ...
                        if (i != 13 && i != 14 && i != 15 && i != 16) 
                            {
                                ...
                                {
                                    // 
                                    clone.add( createClone(meshArray[i], false) );
...
//                        var boxFWC = new THREE.Box3().setFromObject( clone );
//                        for (var j = 0; j < clone.children.length; j++) {
//                            boxFWC.getCenter( clone.children[j].position );
//                            // this re-sets the mesh position
//                            clone.children[j].position.multiplyScalar( - 1 ); 
//                        }
//                        
                    var boxFW = new THREE.Box3().setFromObject( group );
...
//                        for (var i = 0; i < meshArray.length; i++) 
//                        {
//                            meshArray[i].material = matPaint;
////                            meshArray[i].receiveShadow = true;
//                        }
////                        meshArray[3].material = matBrakePad;
////                        meshArray[2].material = matBrakePad;//
////                        meshArray[1].material = matBrakeDisc;
////                        meshArray[5].material = matBrakeDisc;
//                        
////                        var objCloneDiscFront = new THREE.Object3D();
////                        var objCloneCaliperFront = new THREE.Object3D();
////                        var objCloneDiscRear = new THREE.Object3D();
////                        var objCloneCaliperRear = new THREE.Object3D();
////                        
//                        
//                        var objCloneFront = new THREE.Object3D();
//                        var objCloneRear = new THREE.Object3D();
//                        
//                        var box = new THREE.Box3().setFromObject( meshArray[0] );
//                        for (j = 0; j < 4; j++) {
//                            box.getCenter( meshArray[j].position );
//                            meshArray[j].position.multiplyScalar( - 1 );
//                             objCloneRear.add( createClone(meshArray[j]));
//                        }
//                        box = new THREE.Box3().setFromObject( meshArray[4] );
//                        for (j = 4; j < meshArray.length; j++) {
//                            box.getCenter( meshArray[j].position );
//                            meshArray[j].position.multiplyScalar( - 1 );
//                            objCloneFront.add( createClone(meshArray[j]));
//                        }
//////                        objCloneDiscFront.add(objCloneCaliperFront.children[2]);
//////                        objCloneDiscRear.add( objCloneCaliperRear.children[1] );
//////                        objCloneDiscRear.add( objCloneCaliperRear.children[0] );
////
////                        
////                        box = new THREE.Box3().setFromObject( objCloneCaliperFront );
////                        for (j = 0; j < objCloneCaliperFront.children.length; j++) {
////                            box.getCenter( objCloneCaliperFront.children[j].position );
////                            objCloneCaliperFront.children[j].position.multiplyScalar( - 1 );
////                        }
////
////                        box = new THREE.Box3().setFromObject( objCloneCaliperRear );
////                        for (j = 0; j < objCloneCaliperRear.children.length; j++) {
////                            box.getCenter( objCloneCaliperRear.children[j].position );
////                            objCloneCaliperRear.children[j].position.multiplyScalar( - 1 );
////                        }
////                        
////                        pivotWheelFR.add( objCloneCaliperFront );
////                        pivotWheelFRRot.add( objCloneDiscFront );
////                        pivotWheelRR.add( objCloneCaliperRear );
////                        pivotWheelRRRot.add( objCloneDiscRear );
//                        
//                        var n = meshArray.length;
//                        while (n--) {
//                            pivotWheelFL.add( meshArray[n] );
//                        }
//                        n = 4;
//                        while (n--) {
//                            pivotWheelRL.add( meshArray[n] );
//                        }
//                        
//                        pivotWheelFR.add( objCloneFront );
//                        box = new THREE.Box3().setFromObject( objCloneFront.children[0] );
//                        for (j = 0; j < objCloneFront.children.length; j++) {
//                            box.getCenter( objCloneFront.children[j].position );
//                            objCloneFront.children[j].position.multiplyScalar( - 1 );
//                        }
//                        pivotWheelRR.add( objCloneRear );
//                        box = new THREE.Box3().setFromObject( objCloneRear.children[0] );
//                        for (j = 0; j < objCloneRear.children.length; j++) {
//                            box.getCenter( objCloneRear.children[j].position );
//                            objCloneRear.children[j].position.multiplyScalar( - 1 );
//                        }
//                        
//                        
////                        for (j = meshArray.length; j > 2; j--) {
////                            pivotWheelFL.add( meshArray[j] );
////                        }
//                        
//                        
//                    }
...
//                        _this.wheelFL.children[13].scale.set( 1, 1, 0.8);
//                    if (_this.initialise) 
//                    {
////                            assignMaterials(group);
//                        render('wheel');
...
//                        _this.model.position.set(230,67,0);
//                        _this.model.rotation.y = THREE.Math.degToRad(180);
...
//                console.log(color);
            ...
            function createMaterialLibrary()
            {
                ...
                _this.standardMat = new THREE.MeshPhysicalMaterial( {
                            ...
                            roughness: 1,
                            metalness: 0,
//                            map: loaderTextures.load( 'textures/pbr/albeldo.jpg', function ( texture ) {}),
                            envMapIntensity: 1,
                        clearCoat: 1,
                        clearCoatRoughness: 1,
//                        normalMap: loaderTextures.load( 'textures/pbr/normal.jpg', function ( texture ) {}),
//                        normalScale: new THREE.Vector2( 1, 1 ),
                        reflectivity: 1,
//                            metalnessMap: loaderTextures.load( 'textures/pbr/metalness.jpg', function ( texture ) {}),
//                            roughnessMap: loaderTextures.load( 'textures/pbr/roughness.jpg', function ( texture ) {})
                    } );
...
//                                texture.offset.set(0, -1);
                ...
                _this.matDecor = new THREE.MeshPhysicalMaterial( {
                            color: 0xcccccc,
                            roughness: 0.5,
                            metalness: 0.5,
                            clearCoat: 1,
                 ...
                 _this.matCarbon = new THREE.MeshPhysicalMaterial( {
                            color: 0xffffff,
                            roughness: 0.2,
                            metalness: 0,
...
//                            normalMap: _this.wheelTextureNormal2,
//                            bumpScale: 10,
//                            normalScale: new THREE.Vector3( 2, 2 ),
                            clearCoat: 0,
                            clearCoatRoughness: 0.5,
                            envMapIntensity: .3,
                            reflectivity: 0,
...
//                _this.controls.maxDistance = _this.paramsCam.maxDist;
                ...
                // 3/4 REAR LEFT
                case 6:
                             //p {x: 813.6196224874087, y: 173.62173632332997, z: -213.36554549738557}
                    animateCamera({ x: 814, y: 174, z: -213, x2: _this.paramsCam.orbitX, y2: _this.paramsCam.orbitY, z2: _this.paramsCam.orbitZ, fov: _this.paramsCam.fov, wheel: THREE.Math.degToRad(-30)},constraints); 
                    break;
                // SIDE LEFT
                case 7:
...
//                plane.material.opacity = 0.3;
            ...
            function changeRoof() 
            {
                ...
                var group = _this.scene.getObjectByName( "paint" );
                group.children[0].visible = value;
                var group2 = _this.scene.getObjectByName( "door" );
                group2.children[13].visible = value;
                var group3 = _this.scene.getObjectByName( "side" );
                group3.children[29].visible = value;
                group = _this.scene.getObjectByName( "door_clone" );
                group.children[13].visible = value;
                group = _this.scene.getObjectByName( "side_clone" );
                group.children[25].visible = value; //////////// WARNING!!!
            ...
            function changeWheel(num) 
            {
                switch(num){
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            _this.matStripe.color.setHex( 0x000000 );
                            break;
                        case 4:
                            _this.matStripe.color.setHex( 0xFFFFFF );
                            break;
...
//                }
            ...
            {
                var currentEnv = envPos;
//                envGUICurrent = envGUIArray[0];
                if(num == "next" || num == undefined)
                    if (currentEnv == envGUIArray.length - 1)
                        num = 0;
                    else
                        num = currentEnv + 1;
                else if(num == "prev")
                    if (currentEnv == 0)
                        num = envGUIArray.length - 1;
                    else
                        num = currentEnv - 1;
                envPos = num;
//                console.log("changeEnvironment");
                envGUICurrent = envGUIArray[envPos];
                console.log(envGUICurrent);
...
//                renderer.shadowMap.needsUpdate = true;
                if (envGUICurrent != 'studio'){
                    
                    var env = loaderTextures.load( 'textures/' + envGUICurrent + '/pano.jpg', function ( texture ) {
//                    texture.mapping = THREE.EquirectangularReflectionMapping;
                    texture.flipY = true;
                    texture.magFilter = THREE.LinearFilter;
                    texture.minFilter = THREE.LinearFilter;
...
//                    texture.offset.y = 0.05; // 0.0 - 1.0
//                    texture.offset.y = 0.5; // 0.0 - 1.0
//                    texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
//                    equirecTexture = texture;
                    matBlob.map = texture;
                    matBlob.color.setHex( 0xffffff );
                    matBlob.needsUpdate = true;
                    plane.material.opacity = 0.35;
//                    groundshadow.position.y = -25;
                    loadHDRReflection();
//                    updateBlob();
                    });
                ...
                {
                     matBlob.color.setHex( 0x111111 );
                     matBlob.map = null;
                     matBlob.needsUpdate = true;
                     plane.material.opacity = 0;
//                     groundshadow.position.y = -22;
                     loadHDRReflection();
                }
...
//                if(num == "next")
//                    if (currentWheel == _this.wheelTotal)
//                        num = 1;
//                    else
//                        num = currentWheel + 1;
//                if(num == "prev")
//                    if (currentWheel == 1)
//                        num = _this.wheelTotal;
//                    else
//                        num = currentWheel - 1;
//                
////                spinner.classList.remove('hide');
